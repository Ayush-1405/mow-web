// Mood of Wood — MVP Pilot Edge Functions — bilingual (EN/GU) user-safe
// error and status messages. None of these strings ever include internal
// details (SQL error text, stack traces, internal email, etc.) — those are
// only ever written to server-side logs, never returned to the client.
...
export const MSG: Record<string, Bilingual> = {
  invalidJson: {
  ...
  voiceDisabled: {
    en: "Voice notes are disabled in this pilot.",
    gu: "આ પાયલોટમાં વોઇસ નોંધ અક્ષમ છે.",
  },
